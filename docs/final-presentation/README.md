...
4. Consumer Smart Assistant vs. Custom Raspberry Pi Assistant
5. System Goal: low-cost, local hardware control, AI conversation
6. Design and Development
7. Voice Recognition Sensor
8. Raspberry Pi Software Runtime
9. OLED Status Display
10. Electrical Wiring and GPIO
...
The weekly report and code in this repository provide the content for the final presentation.
